...
public class ControladorSistema implements Serializable {
    ...
    private Encargado encargado; // El encargado actual del laboratorio
    ...
    public boolean registrarUsuario(String nombre, String rut) throws IllegalAccessException{
        ...
        return listaPersonas.add(new Usuario(nombre,Rut.valueOf(rut)));
    }
    ...
    public boolean registrarPrestamo(String nombre, String rut, String idEquipo, String horaDevolucion, String motivo) throws IllegalAccessException{
        ...
        listaPrestamos.add( 
                new Prestamo(
                        LocalDate.now().toString(), LocalTime.now().toString(), horaDevolucion, equipo, usuario, motivo, this.encargado
                )
        );
        return true;
    }
